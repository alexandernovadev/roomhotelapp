  ...
  setup(props, { emit }) {
    const buttonClasses = computed(() => {
      ...
      const sizeClasses = {
        ...
        lg: 'pl-6 pr-6 py-3 text-base'
      }

      const variantClasses = {
        primary: 'text-white bg-cyan-600 border border-transparent hover:bg-cyan-700 focus:ring-cyan-500',
        secondary: 'text-neutral-700 bg-white border border-neutral-300 hover:bg-neutral-50 hover:border-neutral-400 focus:ring-neutral-500',
        ...
        ghost: 'text-neutral-700 bg-transparent border border-transparent hover:bg-neutral-100 focus:ring-neutral-500'
      }
